    ...
    fetch("/PracticeFavorite/GetNewEnglishWord")
        ...
        .then(newEnglishWord => {
            if (newEnglishWord && newEnglishWord.trim() !== '') {
                ...
                showNotification("Kelime bulunamadı. Lütfen favorilerinize kelime ekleyin.", "error");
            }
        })
        .catch(error => {
